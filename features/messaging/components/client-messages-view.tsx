...
export function ClientMessagesView(props: { initialChannelId?: string | null }) {
  ...
  return (
    <MessagingInbox
      ...
      layoutClassName="flex h-full w-full min-h-0 flex-1 flex-col overflow-hidden bg-surface-page max-lg:min-h-0 md:h-full md:max-h-full md:min-h-0 md:grid md:grid-cols-[320px_minmax(0,1fr)_300px]"
    />
  );
}
