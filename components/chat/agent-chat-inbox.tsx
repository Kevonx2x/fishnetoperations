...
function AgentChatBody({
  ...
  return (
    <div className="h-[calc(100vh-180px)] md:h-[600px] overflow-hidden bg-[#FAF8F4] flex flex-col md:grid md:grid-cols-[320px_1fr]">
      <div
        className={`flex min-h-0 w-full flex-col shrink-0 border-b border-[#2C2C2C]/10 md:border-b-0 md:border-r md:border-[#2C2C2C]/10 ${
