        ...
        <div className="grid gap-10 lg:grid-cols-[1.2fr_1fr_1fr_1fr]">
          <div>
            ...
            <p className="mt-4 max-w-xs text-sm font-medium leading-relaxed text-white/75">
              Verified dorms and rooms for students, BPO workers, and young professionals across Metro Manila.
            </p>
            <form
            ...
            <p className="mt-2 text-[11px] font-medium text-white/45">Stay in the loop — new listings near your school.</p>
          </div>
          ...
          <div>
            <p className="text-xs font-bold uppercase tracking-wide text-[#A8D4AB]">BahayGo</p>
            <ul className="mt-3 space-y-2 text-sm font-semibold text-white/85">
              <li>
              ...
              <li>
                <Link href="/auth/login" className="hover:text-[#D4A843]">
                  Sign in
                </Link>
              </li>
            </ul>
