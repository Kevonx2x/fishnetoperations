...
import { DormspaceSearchMapCanvas } from "@/components/dormspaces/dormspace-search-map-canvas";
...
export function DormspaceSearchMapPage({ markers: dormspaces }: { markers: SearchMapDormspace[] }) {
      ...
      <div className="relative z-0 min-h-0 flex-1">
        {apiKey ? (
          ...
          <div className="flex h-full w-full flex-col items-center justify-center bg-[#E8F0E9] px-6 text-center">
            <p className="font-sans text-sm font-semibold text-[#2C2C2C]">Map unavailable</p>
            <p className="mt-1 max-w-xs font-sans text-xs font-medium text-[#888888]">
              Add{" "}
