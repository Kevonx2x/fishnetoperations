    ...
    <AnimatePresence>
      {open && deal ? (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 z-[85] flex items-end justify-center bg-black/45 p-4"
    ...
    <AnimatePresence>
      {open && deal ? (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 z-[84] flex items-end justify-center bg-black/45 p-4"
          onClick={() => !busy && onClose()}
        >
          <motion.div
            initial={{ y: 24, opacity: 0 }}
    ...
    <AnimatePresence>
      {open && lead ? (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 z-[86] flex items-end justify-center bg-black/45 p-4"
          onClick={() => !busy && onClose()}
        >
          <motion.div
            initial={{ y: 24, opacity: 0 }}
