-- ---------------------------------------------------------------------------
-- LABEL: Supabase SQL Editor — Pro tier owned cap: 10 (RLS uses listing_limit_for_user)
-- Run in Supabase SQL Editor before relying on app-only limits for Pro inserts.
-- Co-list caps remain enforced in application code (10 for Pro); Featured/Broker unchanged here.
-- ---------------------------------------------------------------------------
